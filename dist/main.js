...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "0619b17d0e6708f5a806";
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  _toConsumableArray(document.querySelectorAll('.nav__item')).forEach(function (menuItem) {
    return menuItem.querySelector('a').classList.toggle('active', menuItem.querySelector('a').pathname === document.location.pathname);
  });
});
